...
# .\Update-Database-EFC.ps1 -projectPath '..\..\src\Curio.Persistence' -startupProjectPath '..\..\src\Curio.Persistence.Tools' -contextName 'CurioIdentityDbContext'
param
( 
    [Alias('p')]
    [Parameter(Mandatory)]
...
dotnet ef --startup-project $startupProjectPath migrations add $migrationName --project $projectPath  --context $contextName --verbose
